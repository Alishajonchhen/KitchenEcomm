...
<nav class="navbar bg-info navbar-fixed-top">
    ...
    margin-top: 10px; margin-bottom: -20px;">Admin <span style="color: white">Dashboard</span>
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                               <i class="icon-user icon-2x"></i> <i class="icon-caret-down"></i>    {{ \Auth::guard('admin')->user()->name }}
                        </a>
...
<div id="mySidebar" class="col-sm-3 col-md-2 sidebar" style="background-color: #366593; height: 950px; color: black; width: 300px;">
