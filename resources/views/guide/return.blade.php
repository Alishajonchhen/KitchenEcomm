...
@section('content')
    <div class="return">
        ...
        <div class="policy">
            <p class="user">All defined terms used below shall have the meanings set forth in Our Terms and Conditions. See <a href="{{route('guide.terms')}}">Terms and Conditions</a></p>
<br>
            ...
            <p class="user">Once an item of merchandise is delivered to you, you can return that item within
                ...
                does not apply to the following goods: [discounted or sale items, used goods, scratched items,etc][include any that are
                applicable].  These items are not eligible for return, refund or exchange.</p>
            <br>
